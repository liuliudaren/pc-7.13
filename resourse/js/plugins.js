...
/*====================
 ...
 =====================*/
var plug={}
plug.banner=function(a,b,c,d,e,f){
...
$.fn.extend({
    subMenu:function(){
        var $mainUl=this.children().eq(0);
        var $mainLi=$mainUl.children();
        var $subUl=this.children().eq(1);
        var $subLi=$subUl.children();
        $mainLi.mouseenter(function(){
            $(this).addClass("active").siblings().removeClass("active");
            $subUl.stop().animate({"height":500});
            $subLi.eq($(this).index()).stop().css({"display":"block"}).animate({"opacity":1})
        ...
        this.mouseleave(function(){
            ...
            $subLi.stop().animate({"opacity":0},function(){
                $(this).css("display","none")
            });
        })
        return this
